#ifndef STATS_SOLUTIONS
#define STATS_SOLUTIONS

const char* descriptive_stats = R"(def get_cov(x,y):
    """
...
const char* descriptive_stats_plots = R"(def normal_hist(data, label, filepath):
    """
